...
/**
 * Side rail — signature: instead of one continuous bar + hover tooltips,
 * the track is split into per-section segments that fill as you pass them,
 * and the active dot permanently expands into a labeled pill (no hover needed).
 */
