import { ArrowUpRight, FileText, Github, X } from 'lucide-react';
            ...
            <div className="flex items-start justify-between gap-4 p-6 sm:p-7 border-b border-border/60">
              <div className="min-w-0">
                <div className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-wider text-primary">
                  ...
                  {project.category}
                  {project.metric && (
                    <span className="ml-2 bg-primary/10 px-2 py-0.5 rounded text-primary">{project.metric}</span>
                  )}
                </div>
            ...
            <div className="p-6 sm:p-7 overflow-y-auto scrollbar-thin">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                {project.paper_url && (
                  ...
                  >
                    <FileText className="h-4 w-4 text-primary" /> Read Paper <ArrowUpRight className="h-3.5 w-3.5" />
                  </a>
                )}
              </div>
            </div>
